...
print(add_indexes([42, -48, 40, -40, -17, -35, -16, 46])) # [42, -47, 42, -37, -13, -30, -10, 53]
print(add_indexes([-28])) # [-28]
print(add_indexes([-6, 12, -39, 40, 23, 33, -44])) # [-6, 13, -37, 43, 27, 38, -38]
print(add_indexes([-14, 10, 21, 40, 35, -36])) # [-14, 11, 23, 43, 39, -31]
print(add_indexes([-33, -35, 34, -39, -18, 17, -44, -23, -30, 43])) # [-33, -34, 36, -36, -14, 22, -38, -16, -22, 52]
print((add_indexes([-45, -22, 18, 26, -37, -26, 26, 37, -7, -31])) # [-45, -21, 20, 29, -33, -21, 32, 44, 1, -22]
print(add_indexes([-32, 41, -14, -43, 30, -24, -30, -18, 21, 30, 39, -45, -11, 9, 5, -12, -3])) # [-32, 42, -12, -40, 34, -19, -24, -11, 29, 39, 49, -34, 1, 22, 19, 3, 13]
print(add_indexes([-9, 21, 17, 48, -36, -16, 24, -15, -41, 47, -28, 2, 28, -12, 40, 27])) # [-9, 22, 19, 51, -32, -11, 30, -8, -33, 56, -18, 13, 40, 1, 54, 42]
print(add_indexes([4, 1, 16, -45, 47, -38, -18])) # [4, 2, 18, -42, 51, -33, -12]
print(add_indexes([12, 36, -42, 38])) # [12, 37, -40, 41]
print(add_indexes([-19, 12, 19, 39])) # [12, 37, -40, 41]
print(add_indexes([5, -4, 26, 1, -43, 17, 14, -44, -40, 22, -22, -32, -13, -21, 50, 4, 12])) # [5, -3, 28, 4, -39, 22, 20, -37, -32, 31, -12, -21, -1, -8, 64, 19, 28]
print(add_indexes([-13, -33])) # [-13, -32]
print(add_indexes([-27, 46, 24, 36, 13, -18, 12])) ## [-27, 47, 26, 39, 17, -13, 18]
print(add_indexes([-42, 18])) # [-42, 19]
print(add_indexes([-5, -10, -6, -34, 32, 15, 9, 32, 20, 36, -16, 5, -42, 14, -35, 22, -18, -29, -17, 29])) # [-5, -9, -4, -31, 36, 20, 15, 39, 28, 45, -6, 16, -30, 27, -21, 37, -2, -12, 1, 48]
print(add_indexes([42, -33, 29, -14, 45, -43, 4, 2, 8, -45, 46, 38, 16])) # [42, -32, 31, -11, 49, -38, 10, 9, 16, -36, 56, 49, 28]
print(add_indexes([-14, 28])) # [-14, 29]